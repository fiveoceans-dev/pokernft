        ...
        return (
          <li key={href}>
            <Link
              ...
              passHref
              className={`${
                isActive ? "!bg-gradient-nav !text-white shadow-md" : ""
              } py-1.5 px-3 text-sm font-bold rounded-full gap-2 grid grid-flow-col hover:bg-gradient-nav hover:text-white hover:shadow-md active:bg-gradient-nav`}
            >
              {icon}
              <span>{label}</span>
            </Link>
